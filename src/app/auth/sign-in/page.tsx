    ...
    <div className="min-h-screen bg-[#0a0a0f] text-zinc-200 flex items-center justify-center p-6" style={{ fontFamily: '"Fragment Mono", monospace' }}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/[0.015] border border-white/[0.08] rounded-2xl p-6">
          <h1 className="text-lg text-white mb-1">Sign in</h1>
          <p className="text-[11px] text-zinc-500 mb-6">Welcome back — coordinate the world.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2 bg-[#ff6a1a] text-black py-2.5 rounded-lg text-[12px] font-bold uppercase tracking-wider hover:bg-[#ff7f3a] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <p className="text-center text-[11px] text-zinc-500 mt-6">
            ...
            <Link href="/auth/sign-up" className="text-[#ff6a1a] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
